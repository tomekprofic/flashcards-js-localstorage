...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function ladujZLocalStorage() {
        ...
        if (!dane) {
            // Jeśli nie ma danych, stwórz zestaw startowy
            wszystkieZestawy = {
                "Przykład: Stolice": [
                    { id: "1", pytanie: "Stolica Polski", odpowiedz: "Warszawa", typ: "fiszka", status: "nowe", gwiazdka: false },
                    { id: "2", pytanie: "Stolica Francji", odpowiedz: "Paryż", typ: "fiszka", status: "nowe", gwiazdka: true }
                ],
                "Przykład: JS Quiz": [
                    {
                        id: "3",
                        pytanie: "Która metoda służy do dodawania elementu na końcu tablicy?",
                        typ: "wybor",
                        opcje: ["push()", "pop()", "shift()"],
                        odpowiedzi: ["push()"],
                        status: "nowe",
                        gwiazdka: false
                    }
            ...
            wszystkieZestawy = JSON.parse(dane);
        }
